...
function descripcionesCat(desc){
    ...
    if(desc == 1){
        Swal.fire({
            title: '<strong>Categoría: Trayectoria juvenil (12-18)</strong>',
            icon: 'info',
            html:
        ...
        Swal.fire({
            title: '<strong>Categoría: Trayectoria juvenil (19-29)</strong>',
            icon: 'info',
            html:
        ...
        Swal.fire({
            title: '<strong>Categoría: Discapacidad e integración</strong>',
            icon: 'info',
            html:
        ...
        Swal.fire({
            title: '<strong>Categoría: Ingenio emprendedor</strong>',
            icon: 'info',
            html:
              'Liderazgo emprendedor en distintas ramas económicas que debe traducirse en habilidad para crear y desarrollar unidades de producción viables y sustentables. Además, de la implementación de iniciativas de negocios, transferencia de tecnología e innovación; fortalecimiento de la planta productiva con impacto en el aspecto económico y social de la comunidad.Asimismo, el  desarrollo, difusión y promoción de una cultura emprendedora; inversión en el desarrollo de capital humano de las organizaciones productivas, destacando: gestión directiva; habilidades gerenciales; capacitación y adiestramiento de personal dirigido a la productividad y crecimiento.',
            showCloseButton: true,
            showCancelButton: false,
            focusConfirm: false,
            confirmButtonColor: '#3085d6',
        ...
        Swal.fire({
            title: '<strong>Categoría: Responsabilidad social</strong>',
            icon: 'info',
            html:
        ...
        Swal.fire({
            title: '<strong>Categoría: Mérito migrante</strong>',
            icon: 'info',
            html:
        ...
        Swal.fire({
            title: '<strong>Categoría: Mérito campesino</strong>',
            icon: 'info',
            html:
        ...
        Swal.fire({
            title: '<strong>Categoría: Protección al medio ambiente</strong>',
            icon: 'info',
            html:
        ...
        Swal.fire({
            title: '<strong>Categoría: Cultura cívica, política y/o democrática</strong>',
            icon: 'info',
            html:
        ...
        Swal.fire({
            title: '<strong>Categoría: Talento joven (Literatura)</strong>',
            icon: 'info',
            html:
    ...
    // talento joven
        ...
        Swal.fire({
            title: '<strong>Categoría: Literatura</strong>',
            icon: 'info',
            html:
              'Escritores(as) del género literario y narrativo: poemas, sonetos, novelas, ensayos y cuentos que hayan permitido fortalecer y salvaguardar las tradiciones de una o de varias regiones del Estado.',
            showCloseButton: true,
        ...
        Swal.fire({
            title: '<strong>Categoría: Artes escénicas (Música)</strong>',
            icon: 'info',
            html:
        ...
        Swal.fire({
            title: '<strong>Categoría: Artes escénicas (Teatro)</strong>',
            icon: 'info',
            html:
        ...
        Swal.fire({
            title: '<strong>Categoría: Artes escénicas (Danza)</strong>',
            icon: 'info',
            html:
        ...
        Swal.fire({
            title: '<strong>Categoría: Artes plásticas, visuales y populares</strong>',
            icon: 'info',
            html:
        ...
        Swal.fire({
            title: '<strong>Categoría: Ciencia y tecnología</strong>',
            icon: 'info',
            html:
